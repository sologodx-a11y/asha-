...
# Force use of PostgreSQL for both local and live (same database)
database_url = 'postgresql://admin:k5uVhCsXflGzxm0APNRX96p7FuXhMvyt@dpg-d92u8h9kh4rs7393uofg-a.singapore-postgres.render.com/salon_gqpw'
